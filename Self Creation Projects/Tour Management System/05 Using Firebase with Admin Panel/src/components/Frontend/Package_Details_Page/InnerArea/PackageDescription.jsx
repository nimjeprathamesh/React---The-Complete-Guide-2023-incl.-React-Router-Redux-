    ...
    return (
        <Box margin='1.2rem 0' width='72%'>
            <Flex justifyContent='space-between'>
                <Heading as='h5'>
                    <Icon as={MdLocationPin} position='relative' bottom='0.1rem' />{selectedPackage.title}
                </Heading>
                <Text className='timeprice'><FontAwesomeIcon icon={faCalendarDays} /> {selectedPackage.duration}</Text>
