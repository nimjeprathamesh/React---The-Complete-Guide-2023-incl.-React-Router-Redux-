...
import EditMembership, { action as UpdateMembership } from '../Pages/Membership/EditMembership.jsx';
import NewMembership, { action as NewMembershipAction } from '../Pages/Membership/NewMembership.jsx';
import EditPackages, { action as UpdatePackage } from '../Pages/Package/EditPackage.jsx';
import NewPackage, { action as NewPackageAction } from '../Pages/Package/NewPackage.jsx';
import EditTestimonial, { action as UpdateTestimonial } from '../Pages/Testimonial/EditTestimonial.jsx';
...
} from './Frontend/Inquiry_Form/InquiryForm.jsx';
...
async function someActionHandler({ request }) {
    return null;
}
...
const router = createBrowserRouter([
    ...
    {path: 'admin/signUp', element: <SignUp />, action: SignUpAction},
    {
        ...
        children: [
            {path: 'homepage', element: <HomePage />, loader: combinedLoader, action: someActionHandler},
            ...
            {path: 'package/:id', element: <EditPackages />, action: UpdatePackage},
            ...
            {path: 'testimonial/:id', element: <EditTestimonial />, action: UpdateTestimonial},
            ...
            {path: 'membership/:id', element: <EditMembership />, action: UpdateMembership}
        ],
    },
]);
